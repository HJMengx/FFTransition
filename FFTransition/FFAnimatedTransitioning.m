...
//            [self.DownLayer addAnimation:self.ToViewAnimationDown forKey:@"ToViewDown"];
//            
//            if(self.IsPresentedComplete){
//                [self CompletionAnimation];
//            }
//            
//            self.IsPresentedComplete = YES;
//        }
//    }else{
//        //dismiss
//        //添加中间层
//        [self.AnimationView.layer addSublayer:self.MiddleLayer];
//        //开始中间动画
//        [self.MiddleLayer addAnimation:self.FromViewAnimationMiddle forKey:@"FromViewMiddle"];
//        
//        if(self.IsDismissComplete){
//            [self CompletionAnimation];
//        }
//        self.IsDismissComplete = YES;
//    }
}
//完成动画
